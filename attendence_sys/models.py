...
def student_directory_path(instance, filename):
    ...
    filename = name +'.'+ ext
    return 'Student_Images/{}/{}/{}/{}/{}'.format(instance.branch,instance.year,instance.section,name,filename)
...
class Student(models.Model):
    ...
    profile_pic = models.FileField(upload_to=student_directory_path ,null=True, blank=True)
